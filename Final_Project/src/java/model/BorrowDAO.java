...
public class BorrowDAO {
    ...
    private static final String GetBorrow = "SELECT b.BorrowID, b.UserID, u.FullName, "
            + "b.BorrowDate, b.ReturnDate, b.Status "
            + "FROM Borrows b "
    ...
    private static final String InsertBorrow = "INSERT INTO Borrows (UserID, BorrowDate, Status) VALUES (?, ?, ?)";
    ...
    public List<BorrowDTO> getAllBorrows() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                list.add(new BorrowDTO(borrowId, userId, fullName,
    ...
    try {
        ...
        while (rs.next()) {
            ...
            list.add(new BorrowDTO(borrowId, userId, fullName, borrowDate, returnDate, status));
        }
    } catch (Exception e) {
        e.printStackTrace();
    }
    ...
    public int createBorrow(BorrowDTO borrow) {
        ...
        try {
            ...
            pst.setString(3, borrow.getStatus());
