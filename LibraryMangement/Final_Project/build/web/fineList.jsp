...
<html>
    ...
    <body>
        <div class="container mt-5">
            <h1 class="mb-4">Fine List</h1>
            <form action="FineController" method="get" class="row g-3 mb-4">
                                        ...
                                        <td>
                                            <c:choose>
                                                <c:when test="${fine.statusCode eq 'Unpaid'}">
                                                    <!-- Mark as Paid -->
                                                    <form action="FineController" method="post" class="d-inline">
                                                    ...
                                                    <!-- Waive -->
                                                    <form action="FineController" method="post" class="d-inline ms-1">
                                                        <input type="hidden" name="action" value="updateStatus"/>
                                                        <input type="hidden" name="fineId" value="${fine.fineID}"/>
            ...
            <a href="MainController?action=home" class="btn btn-secondary mt-3">🏠 Back to Home</a>
        </div>
