...
public boolean hasMoreReadyToExpire() {
    ...
    public void updateReservationsToReady() {
        ...
        String updateDetailSQL =
            "UPDATE ReservationDetails SET StatusCode = 'ReadyToPickup' " +
            "WHERE ReservationID IN (SELECT ReservationID FROM Reservations WHERE StatusCode = 'ReadyToPickup')";
        ...
        try (Connection conn = DBUtils.getConnection()) {
            ...
            try (PreparedStatement ps2 = conn.prepareStatement(updateDetailSQL)) {
                ps2.executeUpdate();
            }
    ...
    public List<ReservationDTO> getReservationsByUserId(int userId) {
        ...
        String sql =
            ...
            "WHERE r.UserID = ? ORDER BY r.ReserveDate DESC";
